...
public static class ConstraintManager
{
    ...
    private static readonly Dictionary<Type, Func<Solver, string, Constraint>> constraintTypeConstructors = new()
    {
        ...
        { typeof(DoubleArrowConstraint), (solver, options) => new DoubleArrowConstraint(solver, options) },
        ...
        { typeof(NabnerConstraint), (solver, options) => new NabnerConstraint(solver, options) },
