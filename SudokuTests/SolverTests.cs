...
public class SolverTests
{
    ...
    {
        Solver solver = SolverFactory.CreateFromGivens(Puzzles.blankGrid, [
            "king",
            "knight",
            "difference:neg1"
        ]);
    ...
    public void SolveDiagonalNonconsecutive()
    {
        ...
        Solver solver = SolverFactory.CreateFromGivens("500000000000000000004000000000080000010200000000956000000000080008304000000000290",
        [
            "dnc"
        ]);
        Assert.AreEqual(LogicResult.PuzzleComplete, solver.ConsolidateBoard());
    ...
    public void KnightmareTest()
    {
        ...
        List<string> additionalConstraints = ["knightmare"];
        List<string> additionalConstraints2 = ["knightmare:5,15"];
